...
use Aydin0098\User\Rules\ValidTeacher;
...
class MobileValidationTest extends TestCase
{
    ...
    {
        $result = (new ValidTeacher())->passes('','0939893313');
        $this->assertEquals(0,$result);

    }
    public function test_mobile_can_not_be_more_than_11_character()
    {
        $result = (new ValidTeacher())->passes('','093989331391');
        $this->assertEquals(0,$result);

    }
    public function test_mobile_start_0()
    {
        $result = (new ValidTeacher())->passes('','3398933139');
        $this->assertEquals(0,$result);
